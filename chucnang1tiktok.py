...
class Zefoy:
    def __init__(self):
        ...
        url1=input("\033[1;34m  █\033[1;37m Link Video:\033[1;31m ")
    ...
    def send_captcha(self, new_session = False):
        if new_session: 
            ...
            time.sleep(2)
        if self.get_captcha(): 
            print('\033[1;34m  █\033[1;32m Đã Chạy Thành Công Tool Buff Tik Tok By:\033[1;31m Thomas Lee\033[1;37m')
    ...
    def get_table(self, i = 1):
        table = PrettyTable(field_names=["ID", "Dịch Vụ Buff (Tik Tok)", "Trạng Thái"], title="Status Services", header_style="upper",border=True)
        while True:
        ...
        for service in self.services:
            ...
            i += 1
        table.title = f"{Fore.WHITE} TOOL By: Thomas Lee: {len([x for x in self.services_status if self.services_status[x]])}{Fore.RESET}"
        print(table)
        ...
        while True:
            ...
            if 'Session expired. Please re-login' in self.video_info:
                ...
                while time.time()-2<_+zefoy:
                    t-=1
                    print('\033[34m  █\033[1;35m Thomas Lee\033[34m █ \033[1;32mVui Lòng Chờ: \033[1;31m{0}\033[32m '.format(t)+'Giây\033[1;32m',end='\r')
                    time.sleep(1)
                continue
    ...
    def select_service(self):
        while True:
            ...
            tim = "\033[1;35m"
            self.get_table()
            print(f"{trang} Chọn:\033[1;31m", end=' ')
            service_id = input()
