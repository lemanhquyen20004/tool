...
def idelay(o):
    while(o>0):
        o=o-1
        print(f"{trang}[{xanhnhat}Thomas Lee{trang}] \033[1;33mD\033[1;34me\033[1;35ml\033[1;32ma\033[1;33my\033{trang}[\033[1;35m.....""]""["+str(o)+"]""    ",end='\r')
        time.sleep(1/6)
        print(f"{trang}[{xanhnhat}Thomas Lee{trang}] \033[1;31mD\033[1;32me\033[1;33ml\033[1;34ma\033[1;35my\033{trang}....""]"f"{trang}[{xanhnhat}"+str(o)+f"{trang}]""     ",end='\r')
        time.sleep(1/6)
        print(f"{trang}[{xanhnhat}Thomas Lee{trang}] \033[1;32mD\033[1;33me\033[1;34ml\033[1;35ma\033[1;36my\033{trang}...""]"f"{trang}[{xanh_la}"+str(o)+f"{trang}]""     ",end='\r')
        time.sleep(1/6)
        print(f"{trang}[{xanhnhat}Thomas Lee{trang}] \033[1;31mD\033[1;33me\033[1;35ml\033[1;33ma\033[1;31my\033{trang}..""]"f"{trang}[{do}"+str(o)+f"{trang}]""     ",end='\r')
        time.sleep(1/6)
        print(f"{trang}[{xanhnhat}Thomas Lee{trang}] \033[1;32mD\033[1;34me\033[1;36ml\033[1;32ma\033[1;34my\033{trang}.""]"f"{trang}[{tim}"+str(o)+f"{trang}]""     ",end='\r')
        time.sleep(1/6)
        print(f"{trang}[{xanhnhat}Thomas Lee{trang}] \033[1;31mD\033[1;34me\033[1;36ml\033[1;32ma\033[1;34my\033{trang}""]"f"{trang}[{vang}"+str(o)+f"{trang}]""     ",end='\r')
        time.sleep(0.1)
        print(f"{trang}[{xanhnhat}Thomas Lee{trang}] \033[1;31mD\033[1;34me\033[1;36ml\033[1;32ma\033[1;34my{trang}[\033[1;33m•••••{trang}""]"f"{trang}[{xanh_la}"+str(o)+f"{trang}]""     ",end='\r')
...
clear()
runbanner(chontool)
idcanspam=input(f'\033[1;97m[\033[1;31m</>\033[1;32m\033[1mNhập id box cần nhây :{vang} ')
while True:
        ...
        try:
          ...
          if ping.status_code == 200:
            for nd in CAU_CHUI:
                ...
                chonname = chon_name
                NOIDUNG = f"id box: {idcanspam} - \033[1;37m {nd}\033[1;31m| \033[1;35mTRẠNG THÁI\033[1;97m: {xanh_la}Nhây Thành Công"
                print(f"{NOIDUNG}")
                idelay(delay)
