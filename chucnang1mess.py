...
def idelay(o):
    while(o>0):
        o=o-1
        print(f"{trang}[{vang}Thomas Lee{trang}] \033[1;33mV\033[1;34mu\033[1;35mi \033[1;32mL\033[1;33mò\033[1;34mn\033[1;35mg \033[1;36mC\033[1;33mh\033[1;34mờ {trang}[\033[1;35m.....""]""["+str(o)+"]""    ",end='\r')
        time.sleep(1/6)
        print(f"{trang}[{xanh_la}Thomas Lee{trang}] \033[1;31mV\033[1;32mu\033[1;33mi \033[1;34mL\033[1;35mò\033[1;31mn\033[1;32mg \033[1;33mC\033[1;32mh\033[1;35mờ {trang}[\033[1;33m•{trang}....""]"f"{trang}[{xanhnhat}"+str(o)+f"{trang}]""     ",end='\r')
        time.sleep(1/6)
        ...
        time.sleep(1/6)
        print(f"{trang}[{xanh_duong}Thomas Lee{trang}] \033[1;31mV\033[1;33mu\033[1;35mi \033[1;33mL\033[1;31mò\033[1;32mn\033[1;34mg \033[1;36mC\033[1;35mh\033[1;31mờ {trang}[\033[1;32m•••{trang}..""]"f"{trang}[{do}"+str(o)+f"{trang}]""     ",end='\r')
        time.sleep(1/6)
        ...
        try:
          ...
          if ping.status_code == 200:
            for nd in CAU_CHUI:
                ...
                chonname = chon_name
                if chonname.lower() == "y":
                    NOIDUNG = f"\033[1;33mCHỬI IB\033[1;97m: {idcanspam} \033[1;31m| \033[1;35mTRẠNG Thái:Thomas Lee đã nhây thành công\033[1;97m: {xanh_la}SUCCESS"
                else:
                    NOIDUNG = f"\033[1;33mCHỬI IB\033[1;97m: {idcanspam} \033[1;31m| \033[1;92mNỘI DUNG\033[1;97m: {nd} \033[1;31m| \033[1;35mTRẠNG THÁI:Thomas Lee đã nhây thành công\033[1;97m: {xanh_la}SUCCESS"
                print(f"{NOIDUNG}")
                idelay(delay)
        except Exception as e:
          print(f"{do}Lỗi bị ngắt kết lối vui lòng kết lối lại mạng để tiếp tục spam")
