...
print(f'\033[1;34m  █ \033[1;32m Bản Quyền Tool Thuộc:\033[1;31m Thầy Kiệt')
time.sleep(0.50)
phone = input("\033[1;34m  █ \033[1;37m Nhập số điện thoại Cần Spam:\033[1;31m ")
delay = float(input("\033[1;34m  █ \033[1;37m Nhập Độ Trễ:\033[1;31m "))
time.sleep(2)
print(f'\033[1;34m  █ \033[1;32m Chạy Ẩn Để Không Bị Văng')
time.sleep(1)
print(f'\033[1;34m  █ \033[1;32m Đang Tiến Hành Spam')
time.sleep(3)
print(f'\033[1;34m  █ \033[1;32m Đang Chạy Ẩn')
time.sleep(4)
print("\033[1;34m  █ \033[1;32m Chạy Xong Tool Sẽ Tự Out")
...
for thread in threads:
    thread.join()
print("\033[1;34m  █ \033[1;32m Đã Spam Thành Công")
